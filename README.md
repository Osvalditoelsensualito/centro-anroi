...
Se generaron automáticamente a partir del logo que ya tenía tu app (el anillo ámbar), tanto
para el ícono de la app como para el ícono de las notificaciones y la pantalla de carga.
